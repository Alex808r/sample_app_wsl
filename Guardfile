...
#строка guard :minitest, spring: true, all_on_start: false do
# заставляет Guard использовать сервер Spring, предоставляемый Rails, для ускорения загрузки,
# а так же не позволяет Guard запустить весь набор тестов при загрузке.
